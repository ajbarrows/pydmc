"""
RDEX-ABCD Stop-Signal Model Implementation using PyMC.

This implements the full RDEX-ABCD model from:
Weigard, A., Matzke, D., Tanis, C., & Heathcote, A. (2023).
A cognitive process modeling framework for the ABCD study stop-signal task.
Developmental Cognitive Neuroscience, 59, 101191.

The model combines:
- Racing diffusion model for go process
- Ex-Gaussian distribution for stop process
- Context independence violation handling (v0, g parameters)
- Trigger failure and go failure parameters
